...
const steps = [
  ["01", "在 ChatGPT 练习", "继续使用 englishTranning 项目，无需改变你的聊天习惯。"],
  ["02", "Worker 安全推送", "本机 Worker 整理学习证据，再通过 API 推送到远程学习库。"],
    ...
    <main className="min-h-screen bg-[#f7f7f2] px-5 py-8 text-[#172223] sm:px-10 lg:px-20">
      ...
      <section className="mx-auto grid max-w-6xl gap-10 py-20 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div>
          ...
          <h1 className="max-w-3xl text-5xl font-black leading-[1.05] tracking-[-0.06em] sm:text-7xl">把每次聊天，<br />变成下一次开口的底气。</h1>
          <p className="mt-7 max-w-xl text-lg leading-8 text-[#53645d]">你照常在 ChatGPT 练英语。本机 Worker 自动整理错误、词汇和发音难点，安全推送到你的线上复习库。</p>
        ...
        <aside className="rounded-[2rem] bg-[#172223] p-6 text-white shadow-2xl shadow-[#172223]/15 sm:p-8">
          <div className="flex items-center justify-between text-sm text-[#b8d0c3]"><span>今日复习</span><span>8–12 分钟</span></div>
          <div className="mt-9 rounded-2xl bg-[#edf6ed] p-6 text-[#172223]"><p className="text-sm font-bold text-[#4e8a70]">ACTIVE RECALL</p><p className="mt-4 text-2xl font-black leading-snug">What does “wrestle with” mean?</p><div className="mt-7 flex gap-2"><span className="rounded-full bg-[#d7ebdc] px-3 py-1 text-xs font-bold">正常朗读</span><span className="rounded-full bg-[#d7ebdc] px-3 py-1 text-xs font-bold">慢速跟读</span></div></div>
